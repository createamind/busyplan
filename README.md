...
> 0.短期目标应该是长期目标分解下来的。长期目标不定的话，短期目标根据什么确定，以及完成后下一阶段的怎么确定，总是要花时间确定长期目标的。

>1.人手资源不足长期目标无法推动？
那不是应该在短期目标里加上怎么招人，整合资源。
怎么整合资源？不也是要多去了解行业需求与痛点，寻求合作。

> 2.在生态中如何定位？不仅要跟同行比，哪些是没人做的我们可以做。还要了解行业需求，找到能够对接业务的公司，有需求的事才有做的价值。什么场景，需要机器替代或增强人的什么功能，感知还是决策，达到什么目的。比如高速场景下货运卡车，驾驶员长时间疲劳驾驶容易出事故，可以用机器代替。低速场景景区交通车，路况简单道路固定，用机器比人更便宜。停车场，入库出库容易撞，机器的安全性更高。

>3.智能不够，学习速度慢，不能用视觉理解世界的抽象概念？但这并不一定是行业的需求和痛点，实现难度和成本太高。定位，识别车道线交通指示牌，行人，车辆，障碍物跟踪预测，也没必要做到理解世界的地步。而且要量产的话还要考虑到成本，计算量太大还要给每台车配gpu主机，厂家也不愿意吧。
