...
目标：
用通用人工智能技术做无人驾驶的研发,以自动驾驶应用为目的的通用人工智能研发

我有思路，但是如何实现是大家一起实践行动来进行逐步设计确定的。很多模型可以外包跑。

目标、问题的梳理参考指南：http://zhibimo.com/read/wang-miao/yuan-ze/Part208My5StepProcesstoGettingWhatYouWantOutofLife.html

限定场景就不是通用智能了，做限定场景我们也做不过其他人。我们就做场景无关的通用智能基础。以我们的视觉系统思路来进行实现通用视觉系统，而非驾驶的专用视觉任务系统，从某一个通用智能的基础点切入。
